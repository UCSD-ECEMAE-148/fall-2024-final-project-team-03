...
VESC_MAX_SPEED_PERCENT = .1 ## Max speed as a percent of actual max speed 
...
PATH_OFFSET = (60, 60)            # 255, 255 is the center of the map. This offset controls where the origin is displayed.
PATH_MIN_DIST = 0.05                 # after travelling this distance (m), save a path point
PATH_SEARCH_LENGTH = None           # number of points to search for closest point, None to search entire path
PATH_LOOK_AHEAD = 10                 # number of points ahead of the closest point to include in cte track
PATH_LOOK_BEHIND = 5               # number of points behind the closest point to include in cte track   
PID_P = 0.025                        # proportional mult for PID path follower
